          ...
          return {
            ...
            link: function (scope, element, attrs) {
              ...
              scope.showFieldsAfterDomRendered = function () {
                ...
                setTimeout(function () {
                  var inputs = scope.element.find("input[lang]");
                  _.each(inputs, function (input) {
                    $(input).next('div').addClass("hidden");
                  });
                  ...
                  if (scope.$parent.isMdMultilingual) {
                    ...
                    _.each(inputs, function (input) {
                      ...
                      $(input).next('div').removeClass("hidden");
                    });
                  } else {
              ...
              scope.initCurrentValues = function() {
                ...
                if (angular.isObject(parentParam)) {
                  // multilingual
                  scope.config.values = angular.extend({}, scope.$parent.params[scope.config.fieldName], emptyLangs);
                  scope.individualValues = _.mapValues(scope.$parent.params[scope.config.fieldName], function(val, key){
